          ...
          <div className="grid grid-cols-1 xl:grid-cols-[1fr_minmax(0,800px)_1fr] gap-8 justify-center items-start">
            ...
            <div className="w-full max-w-[800px] mx-auto px-6">
              ...
              <div className="
                ...
                prose-p:leading-[1.6] [&_blockquote_p:not(:first-of-type)]:text-right [&_blockquote_p:not(:first-of-type)]:mt-4 [&_blockquote_p:not(:first-of-type)]:text-theme-text [&_.text-3xl]:!mt-24 [&_.text-3xl]:!mb-0 [&_.text-3xl]:block [&>div>*:first-child_.text-3xl]:!mt-0 [&>div>*:first-child]:!mt-0
              ">
