...
export default function AdminPage() {
  ...
  const uploadFile = async (file: File) => {
    try {
      ...
      const proxiedUrl = data.publicUrl.replace(
        'https://kksblfpjhrkbuuvsbvcf.supabase.co',
  ...
  const handleEditClick = (post: Post) => {
    ...
    const fixedImageUrl = post.image_url
      ? post.image_url.replace('https://kksblfpjhrkbuuvsbvcf.supabase.co', 'https://img.cataclysm.online')
      : ''
